      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Auction Events</h1>
          </div>
          <div className="flex items-center gap-3">
            <a href="/admin/data-entry" className="btn-secondary transition-all hover:scale-105 active:scale-95 shadow-lg">
              📥 Data Entry
            </a>
            <button className="btn-primary transition-all hover:scale-105 active:scale-95 shadow-lg" onClick={() => setShowForm((v) => !v)}>
        ...
        {/* Create form */}
        {showForm && (
          <div className="card mb-6 border-amber-500/30 animate-slide-up transform origin-top shadow-[0_10px_30px_rgba(245,158,11,0.1)]">
